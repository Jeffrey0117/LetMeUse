...
const i18n: Record<string, Record<string, string>> = {
  ...
  'placeholder.email': { en: 'you@example.com', zh: '請輸入電子信箱' },
  ...
  'switch.toRegisterAction': { en: 'Sign up now', zh: '立即註冊' },
  'switch.toLoginPrompt': { en: 'Already have an account?', zh: '已有帳號？' },
  'switch.toLoginAction': { en: 'Sign in now', zh: '立即登入' },
  'register.terms': { en: 'By signing up you agree to the Terms of Service & Privacy Policy', zh: '註冊登入即表示同意 服務條款、隱私權政策' },
