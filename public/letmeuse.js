"use strict";(()=>{var le={"title.login":{en:"Sign In",zh:"\u767B\u5165"},"title.register":{en:"Create Account",zh:"\u5EFA\u7ACB\u5E33\u865F"},"label.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"label.password":{en:"Password",zh:"\u5BC6\u78BC"},"label.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"btn.login":{en:"Sign In",zh:"\u767B\u5165"},"btn.register":{en:"Create Account",zh:"\u5EFA\u7ACB\u5E33\u865F"},"switch.toRegister":{en:"Don't have an account? Sign up",zh:"\u6C92\u6709\u5E33\u865F\uFF1F\u8A3B\u518A"},"switch.toLogin":{en:"Already have an account? Sign in",zh:"\u5DF2\u6709\u5E33\u865F\uFF1F\u767B\u5165"},"error.generic":{en:"Something went wrong",zh:"\u767C\u751F\u932F\u8AA4"},"error.invalidCredentials":{en:"Invalid email or password",zh:"\u5E33\u865F\u6216\u5BC6\u78BC\u932F\u8AA4"},"error.accountDisabled":{en:"Account is disabled",zh:"\u5E33\u865F\u5DF2\u505C\u7528"},"error.loginFailed":{en:"Login failed",zh:"\u767B\u5165\u5931\u6557"},"error.registrationFailed":{en:"Registration failed",zh:"\u8A3B\u518A\u5931\u6557"},"error.emailInUse":{en:"Email already registered",zh:"\u6B64\u4FE1\u7BB1\u5DF2\u88AB\u8A3B\u518A"},"error.tooManyAttempts":{en:"Too many attempts, please try again later",zh:"\u5617\u8A66\u6B21\u6578\u904E\u591A\uFF0C\u8ACB\u7A0D\u5F8C\u518D\u8A66"},"msg.loading":{en:"Loading...",zh:"\u8F09\u5165\u4E2D..."},"oauth.or":{en:"or continue with",zh:"\u6216\u4F7F\u7528\u4EE5\u4E0B\u65B9\u5F0F\u767B\u5165"},"oauth.google":{en:"Google",zh:"Google"},"oauth.github":{en:"GitHub",zh:"GitHub"},"link.forgotPassword":{en:"Forgot password?",zh:"\u5FD8\u8A18\u5BC6\u78BC\uFF1F"},"error.passwordTooShort":{en:"Password must be at least 8 characters",zh:"\u5BC6\u78BC\u81F3\u5C11\u9700\u8981 8 \u500B\u5B57\u5143"},"forgot.title":{en:"Reset Password",zh:"\u91CD\u8A2D\u5BC6\u78BC"},"forgot.description":{en:"Enter your email to receive a reset link.",zh:"\u8F38\u5165\u4FE1\u7BB1\u4EE5\u6536\u53D6\u91CD\u8A2D\u9023\u7D50\u3002"},"forgot.send":{en:"Send Reset Link",zh:"\u767C\u9001\u91CD\u8A2D\u9023\u7D50"},"forgot.sent":{en:"Check your email for the reset link!",zh:"\u91CD\u8A2D\u9023\u7D50\u5DF2\u5BC4\u51FA\uFF0C\u8ACB\u67E5\u770B\u4FE1\u7BB1\uFF01"},"forgot.backToLogin":{en:"Back to Sign In",zh:"\u8FD4\u56DE\u767B\u5165"},"profile.title":{en:"Account Settings",zh:"\u5E33\u865F\u8A2D\u5B9A"},"profile.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"profile.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"profile.role":{en:"Role",zh:"\u89D2\u8272"},"profile.save":{en:"Save",zh:"\u5132\u5B58"},"profile.saving":{en:"Saving...",zh:"\u5132\u5B58\u4E2D..."},"profile.saved":{en:"Saved!",zh:"\u5DF2\u5132\u5B58\uFF01"},"profile.changePassword":{en:"Change Password",zh:"\u8B8A\u66F4\u5BC6\u78BC"},"profile.currentPassword":{en:"Current Password",zh:"\u76EE\u524D\u5BC6\u78BC"},"profile.newPassword":{en:"New Password",zh:"\u65B0\u5BC6\u78BC"},"profile.confirmPassword":{en:"Confirm Password",zh:"\u78BA\u8A8D\u5BC6\u78BC"},"profile.passwordMismatch":{en:"Passwords do not match",zh:"\u5169\u6B21\u5BC6\u78BC\u4E0D\u4E00\u81F4"},"profile.passwordChanged":{en:"Password changed!",zh:"\u5BC6\u78BC\u5DF2\u8B8A\u66F4\uFF01"},"profile.logout":{en:"Log Out",zh:"\u767B\u51FA"},"profile.avatar":{en:"Change Avatar",zh:"\u66F4\u63DB\u982D\u50CF"},"profile.avatarUploading":{en:"Uploading...",zh:"\u4E0A\u50B3\u4E2D..."},"profile.avatarUpdated":{en:"Avatar updated!",zh:"\u982D\u50CF\u5DF2\u66F4\u65B0\uFF01"},"profile.emailVerified":{en:"Verified",zh:"\u5DF2\u9A57\u8B49"},"profile.emailNotVerified":{en:"Not verified",zh:"\u672A\u9A57\u8B49"},"profile.resendVerification":{en:"Resend",zh:"\u91CD\u5BC4"},"profile.verificationSent":{en:"Verification email sent!",zh:"\u9A57\u8B49\u4FE1\u5DF2\u5BC4\u51FA\uFF01"}},Te={"Invalid credentials":"error.invalidCredentials","Account is disabled":"error.accountDisabled","Login failed":"error.loginFailed","Registration failed":"error.registrationFailed","Email already registered":"error.emailInUse","Too many requests":"error.tooManyAttempts"};function de(e){return t=>le[t]?.[e]??le[t]?.en??t}function O(e,t){let r=Te[e];return r?t(r):e}function P(e){return{bg:e?"#1e1e2e":"#ffffff",textColor:e?"#cdd6f4":"#1e293b",subtextColor:e?"#a6adc8":"#64748b",inputBg:e?"#313244":"#f8fafc",inputBorder:e?"#45475a":"#e2e8f0",errorBg:e?"#3b1c1c":"#fef2f2",errorColor:e?"#f87171":"#dc2626",errorBorder:e?"#5c2828":"#fecaca",hoverBg:e?"#3b3b50":"#f1f5f9",roleBg:e?"#313244":"#f1f5f9",dropdownItemHoverBg:e?"#313244":"#f8fafc"}}function Le(){let e=document.documentElement.getAttribute("data-theme");return e==="dark"?!0:e==="light"?!1:document.documentElement.classList.contains("dark")?!0:window.matchMedia("(prefers-color-scheme: dark)").matches}function ue(e){return e==="auto"?Le():e==="dark"}function I(e){return`
  ...
  `}function ce(e,t){let r=P(t);e.style.setProperty("--lmu-bg",r.bg),e.style.setProperty("--lmu-text",r.textColor),e.style.setProperty("--lmu-subtext",r.subtextColor),e.style.setProperty("--lmu-input-bg",r.inputBg),e.style.setProperty("--lmu-input-border",r.inputBorder),e.style.setProperty("--lmu-error-bg",r.errorBg),e.style.setProperty("--lmu-error-color",r.errorColor),e.style.setProperty("--lmu-error-border",r.errorBorder),e.style.setProperty("--lmu-hover-bg",r.hoverBg),e.style.setProperty("--lmu-role-bg",r.roleBg),e.style.setProperty("--lmu-dropdown-item-hover-bg",r.dropdownItemHoverBg)}var W=class{constructor(t){this.activeShadowHosts=new Set;this.themeSetting=t,this.currentIsDark=ue(t),this.setupAutoTheme()}get isDark(){return this.currentIsDark}registerHost(t){this.activeShadowHosts.add(t)}unregisterHost(t){this.activeShadowHosts.delete(t)}applyToHost(t){ce(t,this.currentIsDark)}updateAllShadowHosts(){for(let t of this.activeShadowHosts)ce(t,this.currentIsDark)}handleThemeChange(){let t=ue(this.themeSetting);t!==this.currentIsDark&&(this.currentIsDark=t,this.updateAllShadowHosts())}setupAutoTheme(){if(this.themeSetting!=="auto")return;new MutationObserver(()=>{this.handleThemeChange()}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","class"]}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{this.handleThemeChange()})}};async function U(e,t,r){let a=await fetch(`${e.baseUrl}${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!a.ok){let o=s.error??"";throw new Error(O(o,e.t)||e.t("error.generic"))}return s.data??s}async function G(e,t,r){let a={};r&&(a.Authorization=`Bearer ${r}`);let s=await fetch(`${e.baseUrl}${t}`,{headers:a}),o=await s.json();if(!s.ok){let p=o.error??"";throw new Error(O(p,e.t)||e.t("error.generic"))}return o.data??o}async function pe(e,t,r,a){let s=await fetch(`${e.baseUrl}${t}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify(r)}),o=await s.json();if(!s.ok){let p=o.error??"";throw new Error(O(p,e.t)||e.t("error.generic"))}return o.data??o}async function me(e,t,r,a){let s=await fetch(`${e.baseUrl}${t}`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify(r)}),o=await s.json();if(!s.ok){let p=o.error??"";throw new Error(O(p,e.t)||e.t("error.generic"))}return o.data??o}var J=class{constructor(t,r){this._currentUser=null;this._ready=!1;this.callbacks=[];this.refreshTimer=null;this.availableProviders=[];this.appId=t,this.apiDeps=r;let a=`lmu_${t}_`;this.accessKey=`${a}access_token`,this.refreshKey=`${a}refresh_token`}get currentUser(){return this._currentUser}set currentUser(t){this._currentUser=t}get ready(){return this._ready}getStoredAccessToken(){return localStorage.getItem(this.accessKey)}getStoredRefreshToken(){return localStorage.getItem(this.refreshKey)}storeTokens(t,r){localStorage.setItem(this.accessKey,t),localStorage.setItem(this.refreshKey,r)}clearTokens(){localStorage.removeItem(this.accessKey),localStorage.removeItem(this.refreshKey)}fireCallbacks(){for(let t of this.callbacks)try{t(this._currentUser)}catch{}}onAuthChange(t){if(this.callbacks.push(t),this._ready)try{t(this._currentUser)}catch{}return()=>{let r=this.callbacks.indexOf(t);r!==-1&&this.callbacks.splice(r,1)}}parseJwtExp(t){try{let r=JSON.parse(atob(t.split(".")[1]));return r.exp?r.exp*1e3:null}catch{return null}}scheduleRefresh(){this.refreshTimer&&clearTimeout(this.refreshTimer);let t=this.getStoredAccessToken();if(!t)return;let r=this.parseJwtExp(t);if(!r)return;let a=r-Date.now()-300*1e3;if(a<=0){this.doRefresh();return}this.refreshTimer=setTimeout(()=>this.doRefresh(),a)}async doRefresh(){let t=this.getStoredRefreshToken();if(t)try{let r=await U(this.apiDeps,"/api/auth/refresh",{refreshToken:t});this.storeTokens(r.accessToken,r.refreshToken),this.scheduleRefresh()}catch{this.clearTokens(),this._currentUser=null,this.fireCallbacks()}}cancelRefresh(){this.refreshTimer&&clearTimeout(this.refreshTimer)}async fetchProviders(){if(this.appId)try{let t=await G(this.apiDeps,`/api/auth/providers?app_id=${this.appId}`,"");this.availableProviders=t.providers??[]}catch{this.availableProviders=[]}}startOAuth(t){let r=encodeURIComponent(window.location.href);window.location.href=`${this.apiDeps.baseUrl}/api/auth/oauth/${t}?app_id=${this.appId}&redirect=${r}`}checkHashTokens(){let t=window.location.hash;if(!t.includes("lmu_token="))return!1;let r=new URLSearchParams(t.slice(1)),a=r.get("lmu_token"),s=r.get("lmu_refresh");return a&&s?(this.storeTokens(a,s),window.history.replaceState(null,"",window.location.pathname+window.location.search),!0):!1}async init(){this.checkHashTokens(),await this.fetchProviders();let t=this.getStoredAccessToken();if(!t){this._ready=!0,this.fireCallbacks();return}try{let r=await G(this.apiDeps,"/api/auth/me",t);this._currentUser=r.user,this.scheduleRefresh()}catch{let r=this.getStoredRefreshToken();if(r)try{let a=await U(this.apiDeps,"/api/auth/refresh",{refreshToken:r});this.storeTokens(a.accessToken,a.refreshToken);let s=await G(this.apiDeps,"/api/auth/me",a.accessToken);this._currentUser=s.user,this.scheduleRefresh()}catch{this.clearTokens()}else this.clearTokens()}this._ready=!0,this.fireCallbacks()}};function ge(e,t){return`
    :host {
      ${t}
  ...
  `}function A(e,t){let{appId:r,accent:a,locale:s,auth:o,theme:p,apiDeps:$,t:i}=e,E=document.getElementById("lmu-auth-host");E&&(p.unregisterHost(E),E.remove());let T=t,m="",f="",n=!1,d=document.createElement("div");d.id="lmu-auth-host",d.style.cssText="position:fixed;inset:0;z-index:99999;";let l=d.attachShadow({mode:"closed"});p.registerHost(d);let v=I(P(p.isDark)),x=ge(a,v);function w(){p.unregisterHost(d),d.remove()}l.addEventListener("click",h=>{let S=l.querySelector(".lmu-card");S&&!S.contains(h.target)&&l.contains(h.target)&&w()});function u(){let h=T==="login";if(T==="forgot"){l.innerHTML=`
          <style>${x}</style>
          <div class="lmu-card">
          ...
          <div class="lmu-section">
            ...
            ${w?`
              <form id="lmu-pw-form">
                ...
                <div class="lmu-row">
                  <button type="submit" class="lmu-btn-sm lmu-btn-primary" ${S?"disabled":""}>
                    ${i(S?"profile.saving":"profile.save")}
                  </button>
      ...
      `,p.applyToHost(k),c.getElementById("lmu-close")?.addEventListener("click",()=>ee());let $e=c.getElementById("lmu-avatar-click"),te=c.getElementById("lmu-avatar-input");$e?.addEventListener("click",()=>te?.click()),te?.addEventListener("change",async()=>{let D=te.files?.[0];if(!(!D||!n)){if(D.size>2*1024*1024){L="",g();return}C=!0,g();try{let z=new FormData;z.append("file",D);let F=await fetch(`${s}/api/auth/avatar`,{method:"POST",headers:{Authorization:`Bearer ${n}`},body:z}),B=await F.json();if(!F.ok)throw new Error(B.error??i("error.generic"));let K=B.data;K?.user&&o.currentUser&&(o.currentUser={...o.currentUser,avatar:K.user.avatar},o.fireCallbacks()),C=!1,L=i("profile.avatarUpdated"),g(),setTimeout(()=>{L="",g()},2e3)}catch{C=!1,g()}}}),c.getElementById("lmu-resend-verify")?.addEventListener("click",async()=>{if(n){try{await U($,"/api/auth/register",{appId:t,resendVerification:!0})}catch{}M=!0,g(),setTimeout(()=>{M=!1},5e3)}}),c.getElementById("lmu-name-edit")?.addEventListener("click",()=>{d=!0,l=o.currentUser?.displayName??"",x=!1,g(),c.getElementById("lmu-name-input")?.focus()}),c.getElementById("lmu-name-cancel")?.addEventListener("click",()=>{d=!1,g()}),c.getElementById("lmu-name-save")?.addEventListener("click",async()=>{let z=c.getElementById("lmu-name-input")?.value?.trim();if(!(!z||!n)){v=!0,g();try{await pe($,"/api/auth/profile",{displayName:z},n),o.currentUser&&(o.currentUser={...o.currentUser,displayName:z},o.fireCallbacks()),d=!1,x=!0,v=!1,g(),setTimeout(()=>{x=!1,g()},2e3)}catch{v=!1,g()}}}),c.getElementById("lmu-pw-show")?.addEventListener("click",()=>{w=!0,u="",h="",g()}),c.getElementById("lmu-pw-cancel")?.addEventListener("click",()=>{w=!1,u="",g()});let ne=c.getElementById("lmu-pw-form");ne?.addEventListener("submit",async D=>{D.preventDefault();let z=new FormData(ne),F=z.get("currentPassword"),B=z.get("newPassword"),K=z.get("confirmPassword");if(B!==K){u=i("profile.passwordMismatch"),g();return}if(B.length<8){u=i("error.passwordTooShort"),g();return}S=!0,u="",g();try{await me($,"/api/auth/change-password",{currentPassword:F,newPassword:B},n),w=!1,S=!1,h=i("profile.passwordChanged"),g(),setTimeout(()=>{h="",g()},3e3)}catch(se){u=se instanceof Error?se.message:i("error.generic"),S=!1,g()}}),c.getElementById("lmu-logout")?.addEventListener("click",()=>{ee(),T()})}g(),document.body.appendChild(k)}function be(e,t){let{accent:r,auth:a,theme:s,t:o,getLoginModalDeps:p,getProfileModalDeps:$,onLogout:i,onAuthChange:E}=e,T=I(P(s.isDark)),m=fe(r,T),f=typeof t=="string"?document.querySelector(t):t;if(!f)return()=>{};let n=document.createElement("div");n.className="lmu-profile-card-host";let d=n.attachShadow({mode:"closed"});s.registerHost(n);function l(){if(!a.currentUser){d.innerHTML=`
          <style>${m}</style>
      ...
      `,s.applyToHost(n),d.getElementById("lmu-pc-logout")?.addEventListener("click",()=>{i()}),d.getElementById("lmu-pc-edit")?.addEventListener("click",()=>{V($())})}f.appendChild(n),l();let v=E(()=>l());return()=>{v(),s.unregisterHost(n),n.remove()}}function ye(e,t){let{accent:r,auth:a,theme:s,t:o,getLoginModalDeps:p,getProfileModalDeps:$,onLogout:i,onAuthChange:E}=e,T=I(P(s.isDark)),m=ve(r,T),f=typeof t=="string"?document.querySelector(t):t;if(!f)return()=>{};let n=document.createElement("div");n.className="lmu-avatar-host";let d=n.attachShadow({mode:"closed"});s.registerHost(n);let l=!1;function v(){if(!a.currentUser){d.innerHTML=`
          <style>${m}</style>
