"use strict";(()=>{(function(){let S=document.currentScript??document.querySelector('script[src*="/letmeuse.js"][data-app-id]'),v=S?.getAttribute("data-app-id")??"",K=S?.getAttribute("data-theme")??"light",c=S?.getAttribute("data-accent")??"#2563eb",M=S?.getAttribute("data-locale")??"en",te=S?.getAttribute("data-mode")??"modal",b=S?.src?new URL(S.src).origin:window.location.origin;v||console.warn("[LetMeUse SDK] Missing data-app-id attribute on script tag.");let re={"title.login":{en:"Sign In",zh:"\u767B\u5165"},"title.register":{en:"Create Account",zh:"\u5EFA\u7ACB\u5E33\u865F"},"label.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"label.password":{en:"Password",zh:"\u5BC6\u78BC"},"label.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"btn.login":{en:"Sign In",zh:"\u767B\u5165"},"btn.register":{en:"Create Account",zh:"\u5EFA\u7ACB\u5E33\u865F"},"switch.toRegister":{en:"Don't have an account? Sign up",zh:"\u6C92\u6709\u5E33\u865F\uFF1F\u8A3B\u518A"},"switch.toLogin":{en:"Already have an account? Sign in",zh:"\u5DF2\u6709\u5E33\u865F\uFF1F\u767B\u5165"},"error.generic":{en:"Something went wrong",zh:"\u767C\u751F\u932F\u8AA4"},"error.invalidCredentials":{en:"Invalid email or password",zh:"\u5E33\u865F\u6216\u5BC6\u78BC\u932F\u8AA4"},"error.accountDisabled":{en:"Account is disabled",zh:"\u5E33\u865F\u5DF2\u505C\u7528"},"error.loginFailed":{en:"Login failed",zh:"\u767B\u5165\u5931\u6557"},"error.registrationFailed":{en:"Registration failed",zh:"\u8A3B\u518A\u5931\u6557"},"error.emailInUse":{en:"Email already registered",zh:"\u6B64\u4FE1\u7BB1\u5DF2\u88AB\u8A3B\u518A"},"error.tooManyAttempts":{en:"Too many attempts, please try again later",zh:"\u5617\u8A66\u6B21\u6578\u904E\u591A\uFF0C\u8ACB\u7A0D\u5F8C\u518D\u8A66"},"msg.loading":{en:"Loading...",zh:"\u8F09\u5165\u4E2D..."},"oauth.or":{en:"or continue with",zh:"\u6216\u4F7F\u7528\u4EE5\u4E0B\u65B9\u5F0F\u767B\u5165"},"oauth.google":{en:"Google",zh:"Google"},"oauth.github":{en:"GitHub",zh:"GitHub"},"link.forgotPassword":{en:"Forgot password?",zh:"\u5FD8\u8A18\u5BC6\u78BC\uFF1F"},"error.passwordTooShort":{en:"Password must be at least 8 characters",zh:"\u5BC6\u78BC\u81F3\u5C11\u9700\u8981 8 \u500B\u5B57\u5143"},"forgot.title":{en:"Reset Password",zh:"\u91CD\u8A2D\u5BC6\u78BC"},"forgot.description":{en:"Enter your email to receive a reset link.",zh:"\u8F38\u5165\u4FE1\u7BB1\u4EE5\u6536\u53D6\u91CD\u8A2D\u9023\u7D50\u3002"},"forgot.send":{en:"Send Reset Link",zh:"\u767C\u9001\u91CD\u8A2D\u9023\u7D50"},"forgot.sent":{en:"Check your email for the reset link!",zh:"\u91CD\u8A2D\u9023\u7D50\u5DF2\u5BC4\u51FA\uFF0C\u8ACB\u67E5\u770B\u4FE1\u7BB1\uFF01"},"forgot.backToLogin":{en:"Back to Sign In",zh:"\u8FD4\u56DE\u767B\u5165"},"profile.title":{en:"Account Settings",zh:"\u5E33\u865F\u8A2D\u5B9A"},"profile.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"profile.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"profile.role":{en:"Role",zh:"\u89D2\u8272"},"profile.save":{en:"Save",zh:"\u5132\u5B58"},"profile.saving":{en:"Saving...",zh:"\u5132\u5B58\u4E2D..."},"profile.saved":{en:"Saved!",zh:"\u5DF2\u5132\u5B58\uFF01"},"profile.changePassword":{en:"Change Password",zh:"\u8B8A\u66F4\u5BC6\u78BC"},"profile.currentPassword":{en:"Current Password",zh:"\u76EE\u524D\u5BC6\u78BC"},"profile.newPassword":{en:"New Password",zh:"\u65B0\u5BC6\u78BC"},"profile.confirmPassword":{en:"Confirm Password",zh:"\u78BA\u8A8D\u5BC6\u78BC"},"profile.passwordMismatch":{en:"Passwords do not match",zh:"\u5169\u6B21\u5BC6\u78BC\u4E0D\u4E00\u81F4"},"profile.passwordChanged":{en:"Password changed!",zh:"\u5BC6\u78BC\u5DF2\u8B8A\u66F4\uFF01"},"profile.logout":{en:"Log Out",zh:"\u767B\u51FA"},"profile.avatar":{en:"Change Avatar",zh:"\u66F4\u63DB\u982D\u50CF"},"profile.avatarUploading":{en:"Uploading...",zh:"\u4E0A\u50B3\u4E2D..."},"profile.avatarUpdated":{en:"Avatar updated!",zh:"\u982D\u50CF\u5DF2\u66F4\u65B0\uFF01"},"profile.emailVerified":{en:"Verified",zh:"\u5DF2\u9A57\u8B49"},"profile.emailNotVerified":{en:"Not verified",zh:"\u672A\u9A57\u8B49"},"profile.resendVerification":{en:"Resend",zh:"\u91CD\u5BC4"},"profile.verificationSent":{en:"Verification email sent!",zh:"\u9A57\u8B49\u4FE1\u5DF2\u5BC4\u51FA\uFF01"}};function r(e){return re[e]?.[M]??re[e]?.en??e}let ve={"Invalid credentials":"error.invalidCredentials","Account is disabled":"error.accountDisabled","Login failed":"error.loginFailed","Registration failed":"error.registrationFailed","Email already registered":"error.emailInUse","Too many requests":"error.tooManyAttempts"};function _(e){let t=ve[e];return t?r(t):e}let oe=`lmu_${v}_`,W=`${oe}access_token`,X=`${oe}refresh_token`;function A(){return localStorage.getItem(W)}function ne(){return localStorage.getItem(X)}function H(e,t){localStorage.setItem(W,e),localStorage.setItem(X,t)}function V(){localStorage.removeItem(W),localStorage.removeItem(X)}async function I(e,t){let o=await fetch(`${b}${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await o.json();if(!o.ok){let i=n.error??"";throw new Error(_(i)||r("error.generic"))}return n.data??n}async function Q(e,t){let o={};t&&(o.Authorization=`Bearer ${t}`);let n=await fetch(`${b}${e}`,{headers:o}),i=await n.json();if(!n.ok){let s=i.error??"";throw new Error(_(s)||r("error.generic"))}return i.data??i}async function be(e,t,o){let n=await fetch(`${b}${e}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify(t)}),i=await n.json();if(!n.ok){let s=i.error??"";throw new Error(_(s)||r("error.generic"))}return i.data??i}async function xe(e,t,o){let n=await fetch(`${b}${e}`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify(t)}),i=await n.json();if(!n.ok){let s=i.error??"";throw new Error(_(s)||r("error.generic"))}return i.data??i}let U=[];async function we(){if(v)try{U=(await Q(`/api/auth/providers?app_id=${v}`,"")).providers??[]}catch{U=[]}}function ae(e){let t=encodeURIComponent(window.location.href);window.location.href=`${b}/api/auth/oauth/${e}?app_id=${v}&redirect=${t}`}let a=null,D=!1,q=[],N=null;function $(){for(let e of q)try{e(a)}catch{}}function ye(e){try{let t=JSON.parse(atob(e.split(".")[1]));return t.exp?t.exp*1e3:null}catch{return null}}function R(){N&&clearTimeout(N);let e=A();if(!e)return;let t=ye(e);if(!t)return;let o=t-Date.now()-300*1e3;if(o<=0){ie();return}N=setTimeout(ie,o)}async function ie(){let e=ne();if(e)try{let t=await I("/api/auth/refresh",{refreshToken:e});H(t.accessToken,t.refreshToken),R()}catch{V(),a=null,$()}}function ke(){let e=window.location.hash;if(!e.includes("lmu_token="))return!1;let t=new URLSearchParams(e.slice(1)),o=t.get("lmu_token"),n=t.get("lmu_refresh");return o&&n?(H(o,n),window.history.replaceState(null,"",window.location.pathname+window.location.search),!0):!1}async function le(){ke(),await we();let e=A();if(!e){D=!0,$();return}try{a=(await Q("/api/auth/me",e)).user,R()}catch{let t=ne();if(t)try{let o=await I("/api/auth/refresh",{refreshToken:t});H(o.accessToken,o.refreshToken),a=(await Q("/api/auth/me",o.accessToken)).user,R()}catch{V()}else V()}D=!0,$()}function se(e){return{bg:e?"#1e1e2e":"#ffffff",textColor:e?"#cdd6f4":"#1e293b",subtextColor:e?"#a6adc8":"#64748b",inputBg:e?"#313244":"#f8fafc",inputBorder:e?"#45475a":"#e2e8f0",errorBg:e?"#3b1c1c":"#fef2f2",errorColor:e?"#f87171":"#dc2626",errorBorder:e?"#5c2828":"#fecaca",hoverBg:e?"#3b3b50":"#f1f5f9",roleBg:e?"#313244":"#f1f5f9",dropdownItemHoverBg:e?"#313244":"#f8fafc"}}function $e(){let e=document.documentElement.getAttribute("data-theme");return e==="dark"?!0:e==="light"?!1:document.documentElement.classList.contains("dark")?!0:window.matchMedia("(prefers-color-scheme: dark)").matches}function de(){return K==="auto"?$e():K==="dark"}let G=de(),x=new Set;function E(e){let t=se(G);e.style.setProperty("--lmu-bg",t.bg),e.style.setProperty("--lmu-text",t.textColor),e.style.setProperty("--lmu-subtext",t.subtextColor),e.style.setProperty("--lmu-input-bg",t.inputBg),e.style.setProperty("--lmu-input-border",t.inputBorder),e.style.setProperty("--lmu-error-bg",t.errorBg),e.style.setProperty("--lmu-error-color",t.errorColor),e.style.setProperty("--lmu-error-border",t.errorBorder),e.style.setProperty("--lmu-hover-bg",t.hoverBg),e.style.setProperty("--lmu-role-bg",t.roleBg),e.style.setProperty("--lmu-dropdown-item-hover-bg",t.dropdownItemHoverBg)}function Ee(){for(let e of x)E(e)}function ce(){let e=de();e!==G&&(G=e,Ee())}K==="auto"&&(new MutationObserver(()=>{ce()}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","class"]}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{ce()}));let ze=se(G);function Te(e){return`
      --lmu-bg: ${e.bg};
  ...
  `;function j(e){let t=document.getElementById("lmu-auth-host");t&&(x.delete(t),t.remove());let o=e,n="",i="",s=!1,m=document.createElement("div");m.id="lmu-auth-host",m.style.cssText="position:fixed;inset:0;z-index:99999;";let d=m.attachShadow({mode:"closed"});x.add(m);function g(){x.delete(m),m.remove()}d.addEventListener("click",p=>{let z=d.querySelector(".lmu-card");z&&!z.contains(p.target)&&d.contains(p.target)&&g()});function f(){let p=o==="login";if(o==="forgot"){d.innerHTML=`
        ...
        `,E(m),d.getElementById("lmu-close-btn")?.addEventListener("click",()=>g()),d.getElementById("lmu-back-login")?.addEventListener("click",()=>{o="login",n="",i="",f()});let y=d.getElementById("lmu-forgot-form");y?.addEventListener("submit",async h=>{h.preventDefault();let k=new FormData(y).get("email");s=!0,n="",f();try{await I("/api/auth/forgot-password",{appId:v,email:k}),s=!1,i=r("forgot.sent"),f()}catch(l){n=l instanceof Error?l.message:r("error.generic"),s=!1,f()}});return}d.innerHTML=`
        <style>${ue}</style>
        <div class="lmu-card">
          <button class="lmu-close" id="lmu-close-btn">&times;</button>
          ...
          <form id="lmu-auth-form">
            ...
            ${p?`<div style="text-align:right;margin:-10px 0 8px 0;"><a id="lmu-forgot-pw" style="font-size:12px;color:${c};cursor:pointer;text-decoration:none;">${r("link.forgotPassword")}</a></div>`:""}
            <button class="lmu-btn" type="submit" ${s?"disabled":""}>
      ...
      `,E(m),d.getElementById("lmu-close-btn")?.addEventListener("click",()=>g()),d.getElementById("lmu-oauth-google")?.addEventListener("click",()=>ae("google")),d.getElementById("lmu-oauth-github")?.addEventListener("click",()=>ae("github")),d.getElementById("lmu-forgot-pw")?.addEventListener("click",()=>{o="forgot",n="",i="",f()}),d.getElementById("lmu-switch-mode")?.addEventListener("click",()=>{o=p?"register":"login",n="",f()});let T=d.getElementById("lmu-auth-form");T?.addEventListener("submit",async y=>{if(y.preventDefault(),s)return;let h=new FormData(T),u=h.get("email"),k=h.get("password");if(s=!0,n="",f(),!p&&k.length<8){n=r("error.passwordTooShort"),s=!1,f();return}try{if(p){let l=await I("/api/auth/login",{appId:v,email:u,password:k});H(l.accessToken,l.refreshToken),a=l.user,R(),$(),g()}else{let l=h.get("displayName"),L=await I("/api/auth/register",{appId:v,email:u,password:k,displayName:l});H(L.accessToken,L.refreshToken),a=L.user,R(),$(),g()}}catch(l){n=l instanceof Error?l.message:r("error.generic"),s=!1,f()}})}f(),document.body.appendChild(m),setTimeout(()=>{d.querySelector("input")?.focus()},50)}let Le=`
    :host {
      ${Y}
      position: fixed !important;
      inset: 0 !important;
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .lmu-input:focus { border-color: ${c}; box-shadow: 0 0 0 3px ${c}22; }
  ...
  `;function Z(){if(!a){j("login");return}let e=document.getElementById("lmu-profile-host");e&&(x.delete(e),e.remove());let t=A();if(!t)return;let o=t,n=!1,i=a.displayName,s=!1,m=!1,d=!1,g="",f="",p=!1,z=!1,T="",y=!1,h=document.createElement("div");h.id="lmu-profile-host",h.style.cssText="position:fixed;inset:0;z-index:99999;";let u=h.attachShadow({mode:"closed"});x.add(h);function k(){x.delete(h),h.remove()}u.addEventListener("click",L=>{let F=u.querySelector(".lmu-card");F&&!F.contains(L.target)&&u.contains(L.target)&&k()});function l(){if(!a)return;let L=a.displayName?.charAt(0)?.toUpperCase()??"?",F=a.avatar?a.avatar.startsWith("http")?a.avatar:`${b}${a.avatar}`:"",ge=a.emailVerified===!0;u.innerHTML=`
        <style>${Le}</style>
        <div class="lmu-card">
          ...
          <div class="lmu-avatar-area">
            ...
            <div class="lmu-avatar-info">
              ...
              <div style="display:flex;align-items:center;gap:8px;margin-top:2px;">
                ...
                ${ge?`<span class="lmu-badge lmu-badge-verified">${r("profile.emailVerified")}</span>`:`<span class="lmu-badge lmu-badge-unverified">${r("profile.emailNotVerified")}</span>`}
              </div>
              ${!ge&&!y?`<a id="lmu-resend-verify" style="font-size:11px;color:${c};cursor:pointer;margin-top:4px;display:inline-block;">${r("profile.resendVerification")}</a>`:""}
      ...
      `,E(h),u.getElementById("lmu-close")?.addEventListener("click",()=>k());let Ie=u.getElementById("lmu-avatar-click"),ee=u.getElementById("lmu-avatar-input");Ie?.addEventListener("click",()=>ee?.click()),ee?.addEventListener("change",async()=>{let B=ee.files?.[0];if(!(!B||!o)){if(B.size>2*1024*1024){T="",l();return}z=!0,l();try{let w=new FormData;w.append("file",B);let O=await fetch(`${b}/api/auth/avatar`,{method:"POST",headers:{Authorization:`Bearer ${o}`},body:w}),C=await O.json();if(!O.ok)throw new Error(C.error??r("error.generic"));let J=C.data;J?.user&&a&&(a={...a,avatar:J.user.avatar},$()),z=!1,T=r("profile.avatarUpdated"),l(),setTimeout(()=>{T="",l()},2e3)}catch{z=!1,l()}}}),u.getElementById("lmu-resend-verify")?.addEventListener("click",async()=>{if(o){try{await I("/api/auth/register",{appId:v,resendVerification:!0})}catch{}y=!0,l(),setTimeout(()=>{y=!1},5e3)}}),u.getElementById("lmu-name-edit")?.addEventListener("click",()=>{n=!0,i=a?.displayName??"",m=!1,l(),u.getElementById("lmu-name-input")?.focus()}),u.getElementById("lmu-name-cancel")?.addEventListener("click",()=>{n=!1,l()}),u.getElementById("lmu-name-save")?.addEventListener("click",async()=>{let w=u.getElementById("lmu-name-input")?.value?.trim();if(!(!w||!o)){s=!0,l();try{await be("/api/auth/profile",{displayName:w},o),a&&(a={...a,displayName:w},$()),n=!1,m=!0,s=!1,l(),setTimeout(()=>{m=!1,l()},2e3)}catch{s=!1,l()}}}),u.getElementById("lmu-pw-show")?.addEventListener("click",()=>{d=!0,g="",f="",l()}),u.getElementById("lmu-pw-cancel")?.addEventListener("click",()=>{d=!1,g="",l()});let fe=u.getElementById("lmu-pw-form");fe?.addEventListener("submit",async B=>{B.preventDefault();let w=new FormData(fe),O=w.get("currentPassword"),C=w.get("newPassword"),J=w.get("confirmPassword");if(C!==J){g=r("profile.passwordMismatch"),l();return}if(C.length<8){g=r("error.passwordTooShort"),l();return}p=!0,g="",l();try{await xe("/api/auth/change-password",{currentPassword:O,newPassword:C},o),d=!1,p=!1,f=r("profile.passwordChanged"),l(),setTimeout(()=>{f="",l()},3e3)}catch(he){g=he instanceof Error?he.message:r("error.generic"),p=!1,l()}}),u.getElementById("lmu-logout")?.addEventListener("click",()=>{k(),P.logout()})}l(),document.body.appendChild(h)}let me=`
    :host {
      ${Y}
      display: block;
      font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
  ...
  `;function Se(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t)return()=>{};let o=document.createElement("div");o.className="lmu-profile-card-host";let n=o.attachShadow({mode:"closed"});x.add(o);function i(){if(!a){n.innerHTML=`
          <style>${me}</style>
      ...
      `,E(o),n.getElementById("lmu-pc-logout")?.addEventListener("click",()=>{P.logout()}),n.getElementById("lmu-pc-edit")?.addEventListener("click",()=>{Z()})}t.appendChild(o),i();let s=P.onAuthChange(()=>i());return()=>{s(),x.delete(o),o.remove()}}let pe=`
    :host {
      ${Y}
      display: inline-block;
      position: relative;
  ...
  `;function Be(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t)return()=>{};let o=document.createElement("div");o.className="lmu-avatar-host";let n=o.attachShadow({mode:"closed"});x.add(o);let i=!1;function s(){if(!a){n.innerHTML=`
          <style>${pe}</style>
        ...
        `:""}
      `,E(o),n.getElementById("lmu-av-toggle")?.addEventListener("click",()=>{i=!i,s()}),n.getElementById("lmu-av-profile")?.addEventListener("click",()=>{i=!1,s(),Z()}),n.getElementById("lmu-av-logout")?.addEventListener("click",()=>{i=!1,P.logout()})}function m(g){i&&!o.contains(g.target)&&(i=!1,s())}document.addEventListener("click",m),t.appendChild(o),s();let d=P.onAuthChange(()=>{i=!1,s()});return()=>{d(),x.delete(o),document.removeEventListener("click",m),o.remove()}}let P={get ready(){return D},get user(){return a},login(){if(te==="redirect"){window.location.href=`${b}/login?app=${v}&redirect=${encodeURIComponent(window.location.href)}`;return}j("login")},register(){if(te==="redirect"){window.location.href=`${b}/login?app=${v}&redirect=${encodeURIComponent(window.location.href)}&tab=register`;return}j("register")},async logout(){let e=A();if(e)try{await fetch(`${b}/api/auth/logout`,{method:"POST",headers:{Authorization:`Bearer ${e}`}})}catch{}V(),a=null,N&&clearTimeout(N),$()},getToken(){return A()},onAuthChange(e){if(q.push(e),D)try{e(a)}catch{}return()=>{let t=q.indexOf(e);t!==-1&&q.splice(t,1)}},openAdmin(){window.open(`${b}/admin`,"_blank")},openProfile(){Z()},renderProfileCard(e){return Se(e)},renderAvatar(e){return Be(e)}};window.letmeuse=P,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>le()):le()})();})();
