"use strict";(()=>{var pe={"title.login":{en:"Sign In",zh:"\u767B\u5165"},"title.register":{en:"Create Account",zh:"\u5EFA\u7ACB\u5E33\u865F"},"label.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"label.password":{en:"Password",zh:"\u5BC6\u78BC"},"label.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"placeholder.email":{en:"you@example.com",zh:"\u8ACB\u8F38\u5165\u96FB\u5B50\u4FE1\u7BB1"},"placeholder.password":{en:"Enter your password",zh:"\u8ACB\u8F38\u5165\u5BC6\u78BC"},"placeholder.passwordNew":{en:"At least 8 characters",zh:"\u5BC6\u78BC\u9577\u5EA6\u6700\u4F4E 8 \u4F4D"},"placeholder.displayName":{en:"Your name",zh:"\u8ACB\u8F38\u5165\u986F\u793A\u540D\u7A31"},"btn.login":{en:"Sign In Now",zh:"\u7ACB\u5373\u767B\u5165"},"btn.register":{en:"Sign Up Now",zh:"\u7ACB\u5373\u8A3B\u518A"},"switch.toRegisterPrompt":{en:"Don't have an account yet?",zh:"\u9084\u6C92\u6709\u5E33\u865F\uFF1F"},"switch.toRegisterAction":{en:"Sign up now",zh:"\u7ACB\u5373\u8A3B\u518A"},"switch.toLoginPrompt":{en:"Already have an account?",zh:"\u5DF2\u6709\u5E33\u865F\uFF1F"},"switch.toLoginAction":{en:"Sign in now",zh:"\u7ACB\u5373\u767B\u5165"},"register.terms":{en:"By signing up you agree to the Terms of Service & Privacy Policy",zh:"\u8A3B\u518A\u767B\u5165\u5373\u8868\u793A\u540C\u610F \u670D\u52D9\u689D\u6B3E\u3001\u96B1\u79C1\u6B0A\u653F\u7B56"},"error.generic":{en:"Something went wrong",zh:"\u767C\u751F\u932F\u8AA4"},"error.invalidCredentials":{en:"Invalid email or password",zh:"\u5E33\u865F\u6216\u5BC6\u78BC\u932F\u8AA4"},"error.accountDisabled":{en:"Account is disabled",zh:"\u5E33\u865F\u5DF2\u505C\u7528"},"error.loginFailed":{en:"Login failed",zh:"\u767B\u5165\u5931\u6557"},"error.registrationFailed":{en:"Registration failed",zh:"\u8A3B\u518A\u5931\u6557"},"error.emailInUse":{en:"Email already registered",zh:"\u6B64\u4FE1\u7BB1\u5DF2\u88AB\u8A3B\u518A"},"error.tooManyAttempts":{en:"Too many attempts, please try again later",zh:"\u5617\u8A66\u6B21\u6578\u904E\u591A\uFF0C\u8ACB\u7A0D\u5F8C\u518D\u8A66"},"msg.loading":{en:"Loading...",zh:"\u8F09\u5165\u4E2D..."},"oauth.or":{en:"or continue with",zh:"\u6216\u4F7F\u7528\u4EE5\u4E0B\u65B9\u5F0F\u767B\u5165"},"oauth.google":{en:"Google",zh:"Google"},"oauth.github":{en:"GitHub",zh:"GitHub"},"link.forgotPassword":{en:"Forgot password?",zh:"\u5FD8\u8A18\u5BC6\u78BC\uFF1F"},"error.passwordTooShort":{en:"Password must be at least 8 characters",zh:"\u5BC6\u78BC\u81F3\u5C11\u9700\u8981 8 \u500B\u5B57\u5143"},"forgot.title":{en:"Reset Password",zh:"\u91CD\u8A2D\u5BC6\u78BC"},"forgot.description":{en:"Enter your email to receive a reset link.",zh:"\u8F38\u5165\u4FE1\u7BB1\u4EE5\u6536\u53D6\u91CD\u8A2D\u9023\u7D50\u3002"},"forgot.send":{en:"Send Reset Link",zh:"\u767C\u9001\u91CD\u8A2D\u9023\u7D50"},"forgot.sent":{en:"Check your email for the reset link!",zh:"\u91CD\u8A2D\u9023\u7D50\u5DF2\u5BC4\u51FA\uFF0C\u8ACB\u67E5\u770B\u4FE1\u7BB1\uFF01"},"forgot.backToLogin":{en:"Back to Sign In",zh:"\u8FD4\u56DE\u767B\u5165"},"profile.title":{en:"Account Settings",zh:"\u5E33\u865F\u8A2D\u5B9A"},"profile.displayName":{en:"Display Name",zh:"\u986F\u793A\u540D\u7A31"},"profile.email":{en:"Email",zh:"\u96FB\u5B50\u4FE1\u7BB1"},"profile.role":{en:"Role",zh:"\u89D2\u8272"},"profile.save":{en:"Save",zh:"\u5132\u5B58"},"profile.saving":{en:"Saving...",zh:"\u5132\u5B58\u4E2D..."},"profile.saved":{en:"Saved!",zh:"\u5DF2\u5132\u5B58\uFF01"},"profile.changePassword":{en:"Change Password",zh:"\u8B8A\u66F4\u5BC6\u78BC"},"profile.currentPassword":{en:"Current Password",zh:"\u76EE\u524D\u5BC6\u78BC"},"profile.newPassword":{en:"New Password",zh:"\u65B0\u5BC6\u78BC"},"profile.confirmPassword":{en:"Confirm Password",zh:"\u78BA\u8A8D\u5BC6\u78BC"},"profile.passwordMismatch":{en:"Passwords do not match",zh:"\u5169\u6B21\u5BC6\u78BC\u4E0D\u4E00\u81F4"},"profile.passwordChanged":{en:"Password changed!",zh:"\u5BC6\u78BC\u5DF2\u8B8A\u66F4\uFF01"},"profile.logout":{en:"Log Out",zh:"\u767B\u51FA"},"profile.avatar":{en:"Change Avatar",zh:"\u66F4\u63DB\u982D\u50CF"},"profile.avatarUploading":{en:"Uploading...",zh:"\u4E0A\u50B3\u4E2D..."},"profile.avatarUpdated":{en:"Avatar updated!",zh:"\u982D\u50CF\u5DF2\u66F4\u65B0\uFF01"},"profile.emailVerified":{en:"Verified",zh:"\u5DF2\u9A57\u8B49"},"profile.emailNotVerified":{en:"Not verified",zh:"\u672A\u9A57\u8B49"},"profile.resendVerification":{en:"Resend",zh:"\u91CD\u5BC4"},"profile.verificationSent":{en:"Verification email sent!",zh:"\u9A57\u8B49\u4FE1\u5DF2\u5BC4\u51FA\uFF01"}},Ee={"Invalid credentials":"error.invalidCredentials","Account is disabled":"error.accountDisabled","Login failed":"error.loginFailed","Registration failed":"error.registrationFailed","Email already registered":"error.emailInUse","Too many requests":"error.tooManyAttempts"};function me(e){return t=>pe[t]?.[e]??pe[t]?.en??t}function q(e,t){let r=Ee[e];return r?t(r):e}function A(e){return{bg:e?"#1e1e2e":"#ffffff",textColor:e?"#cdd6f4":"#1e293b",subtextColor:e?"#a6adc8":"#64748b",inputBg:e?"#313244":"#f8fafc",inputBorder:e?"#45475a":"#e2e8f0",errorBg:e?"#3b1c1c":"#fef2f2",errorColor:e?"#f87171":"#dc2626",errorBorder:e?"#5c2828":"#fecaca",hoverBg:e?"#3b3b50":"#f1f5f9",roleBg:e?"#313244":"#f1f5f9",dropdownItemHoverBg:e?"#313244":"#f8fafc"}}function Ue(){let e=document.documentElement.getAttribute("data-theme");return e==="dark"?!0:e==="light"?!1:document.documentElement.classList.contains("dark")?!0:window.matchMedia("(prefers-color-scheme: dark)").matches}function ge(e){return e==="auto"?Ue():e==="dark"}function B(e){return`
  ...
  `}function he(e,t){let r=A(t);e.style.setProperty("--lmu-bg",r.bg),e.style.setProperty("--lmu-text",r.textColor),e.style.setProperty("--lmu-subtext",r.subtextColor),e.style.setProperty("--lmu-input-bg",r.inputBg),e.style.setProperty("--lmu-input-border",r.inputBorder),e.style.setProperty("--lmu-error-bg",r.errorBg),e.style.setProperty("--lmu-error-color",r.errorColor),e.style.setProperty("--lmu-error-border",r.errorBorder),e.style.setProperty("--lmu-hover-bg",r.hoverBg),e.style.setProperty("--lmu-role-bg",r.roleBg),e.style.setProperty("--lmu-dropdown-item-hover-bg",r.dropdownItemHoverBg)}var G=class{constructor(t){this.activeShadowHosts=new Set;this.themeSetting=t,this.currentIsDark=ge(t),this.setupAutoTheme()}get isDark(){return this.currentIsDark}registerHost(t){this.activeShadowHosts.add(t)}unregisterHost(t){this.activeShadowHosts.delete(t)}applyToHost(t){he(t,this.currentIsDark)}updateAllShadowHosts(){for(let t of this.activeShadowHosts)he(t,this.currentIsDark)}handleThemeChange(){let t=ge(this.themeSetting);t!==this.currentIsDark&&(this.currentIsDark=t,this.updateAllShadowHosts())}setupAutoTheme(){if(this.themeSetting!=="auto")return;new MutationObserver(()=>{this.handleThemeChange()}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","class"]}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{this.handleThemeChange()})}};var S=class extends Error{constructor(t,r){super(t),this.status=r}};async function P(e,t,r){let a=await fetch(`${e.baseUrl}${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),n=await a.json();if(!a.ok){let i=n.error??"";throw new S(q(i,e.t)||e.t("error.generic"),a.status)}return n.data??n}async function J(e,t,r){let a={};r&&(a.Authorization=`Bearer ${r}`);let n=await fetch(`${e.baseUrl}${t}`,{headers:a}),i=await n.json();if(!n.ok){let p=i.error??"";throw new S(q(p,e.t)||e.t("error.generic"),n.status)}return i.data??i}async function fe(e,t,r,a){let n=await fetch(`${e.baseUrl}${t}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify(r)}),i=await n.json();if(!n.ok){let p=i.error??"";throw new S(q(p,e.t)||e.t("error.generic"),n.status)}return i.data??i}async function ve(e,t,r,a){let n=await fetch(`${e.baseUrl}${t}`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify(r)}),i=await n.json();if(!n.ok){let p=i.error??"";throw new S(q(p,e.t)||e.t("error.generic"),n.status)}return i.data??i}function ie(e){return e instanceof S&&e.status===401}var Y=class{constructor(t,r){this._currentUser=null;this._ready=!1;this.callbacks=[];this.refreshTimer=null;this.availableProviders=[];this.requireEmailVerification=!1;this.appId=t,this.apiDeps=r;let a=`lmu_${t}_`;this.accessKey=`${a}access_token`,this.refreshKey=`${a}refresh_token`,this._readyPromise=new Promise(n=>{this._readyResolve=n})}get currentUser(){return this._currentUser}set currentUser(t){this._currentUser=t}get ready(){return this._ready}whenReady(){return this._readyPromise}getStoredAccessToken(){return localStorage.getItem(this.accessKey)}getStoredRefreshToken(){return localStorage.getItem(this.refreshKey)}storeTokens(t,r){localStorage.setItem(this.accessKey,t),localStorage.setItem(this.refreshKey,r)}clearTokens(){localStorage.removeItem(this.accessKey),localStorage.removeItem(this.refreshKey)}fireCallbacks(t="init"){for(let r of this.callbacks)try{r(this._currentUser,t)}catch{}}onAuthChange(t){if(this.callbacks.push(t),this._ready)try{t(this._currentUser,"init")}catch{}return()=>{let r=this.callbacks.indexOf(t);r!==-1&&this.callbacks.splice(r,1)}}parseJwtExp(t){try{let r=t.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),a=Uint8Array.from(atob(r),i=>i.charCodeAt(0)),n=JSON.parse(new TextDecoder().decode(a));return n.exp?n.exp*1e3:null}catch{return null}}scheduleRefresh(){this.refreshTimer&&clearTimeout(this.refreshTimer);let t=this.getStoredAccessToken();if(!t)return;let r=this.parseJwtExp(t);if(!r)return;let a=r-Date.now()-300*1e3;if(a<=0){this.doRefresh();return}this.refreshTimer=setTimeout(()=>this.doRefresh(),a)}async doRefresh(){let t=this.getStoredRefreshToken();if(t)try{let r=await P(this.apiDeps,"/api/auth/refresh",{refreshToken:t});this.storeTokens(r.accessToken,r.refreshToken),this.scheduleRefresh()}catch(r){ie(r)?(this.clearTokens(),this._currentUser=null,this.fireCallbacks("refresh_failed")):this.refreshTimer=setTimeout(()=>this.doRefresh(),60*1e3)}}cancelRefresh(){this.refreshTimer&&clearTimeout(this.refreshTimer)}async fetchProviders(){if(this.appId)try{let t=await J(this.apiDeps,`/api/auth/providers?app_id=${this.appId}`,"");this.availableProviders=t.providers??[],this.requireEmailVerification=t.requireEmailVerification===!0}catch{this.availableProviders=[],this.requireEmailVerification=!1}}startOAuth(t){let r=encodeURIComponent(window.location.href);window.location.href=`${this.apiDeps.baseUrl}/api/auth/oauth/${t}?app_id=${this.appId}&redirect=${r}`}checkHashTokens(){let t=window.location.hash;if(!t.includes("lmu_token="))return!1;let r=new URLSearchParams(t.slice(1)),a=r.get("lmu_token"),n=r.get("lmu_refresh");return a&&n?(this.storeTokens(a,n),window.history.replaceState(null,"",window.location.pathname+window.location.search),!0):!1}async init(){this.checkHashTokens(),await this.fetchProviders();let t=this.getStoredAccessToken();if(!t){this._ready=!0,this._readyResolve(null),this.fireCallbacks("init");return}try{let r=await J(this.apiDeps,"/api/auth/me",t);this._currentUser=r.user,this.scheduleRefresh()}catch(r){let a=this.getStoredRefreshToken();if(a)try{let n=await P(this.apiDeps,"/api/auth/refresh",{refreshToken:a});this.storeTokens(n.accessToken,n.refreshToken);let i=await J(this.apiDeps,"/api/auth/me",n.accessToken);this._currentUser=i.user,this.scheduleRefresh()}catch(n){ie(n)&&this.clearTokens()}else ie(r)&&this.clearTokens()}this._ready=!0,this._readyResolve(this._currentUser),this.fireCallbacks("init")}};function be(e,t){return`
    :host {
      ${t}
  ...
  `}function C(e,t){let{appId:r,accent:a,locale:n,auth:i,theme:p,apiDeps:$,t:o}=e,E=document.getElementById("lmu-auth-host");E&&(p.unregisterHost(E),E.remove());let T=t,m="",f="",s=!1,d=document.createElement("div");d.id="lmu-auth-host",d.style.cssText="position:fixed;inset:0;z-index:99999;";let l=d.attachShadow({mode:"closed"});p.registerHost(d);let v=B(A(p.isDark)),x=be(a,v);function w(){p.unregisterHost(d),d.remove()}l.addEventListener("click",g=>{let U=l.querySelector(".lmu-card");U&&!U.contains(g.target)&&l.contains(g.target)&&w()});function u(){let g=T==="login";if(T==="forgot"){l.innerHTML=`
          ...
          <div class="lmu-avatar-area">
            ...
            <div class="lmu-avatar-info">
              ...
              <div style="display:flex;align-items:center;gap:8px;margin-top:2px;">
                ...
                ${re?de?`<span class="lmu-badge lmu-badge-verified">${o("profile.emailVerified")}</span>`:`<span class="lmu-badge lmu-badge-unverified">${o("profile.emailNotVerified")}</span>`:""}
              </div>
              ${re&&!de&&!z?`<a id="lmu-resend-verify" style="font-size:11px;color:${r};cursor:pointer;margin-top:4px;display:inline-block;">${o("profile.resendVerification")}</a>`:""}
              ${re&&z?`<span style="font-size:11px;color:#059669;margin-top:4px;display:inline-block;">${o("profile.verificationSent")}</span>`:""}
            </div>
          </div>
      ...
      `,p.applyToHost(k),c.getElementById("lmu-close")?.addEventListener("click",()=>te());let Me=c.getElementById("lmu-avatar-click"),oe=c.getElementById("lmu-avatar-input");Me?.addEventListener("click",()=>oe?.click()),oe?.addEventListener("change",async()=>{let I=oe.files?.[0];if(!(!I||!s)){if(I.size>2*1024*1024){L="",h();return}D=!0,h();try{let M=new FormData;M.append("file",I);let F=await fetch(`${n}/api/auth/avatar`,{method:"POST",headers:{Authorization:`Bearer ${s}`},body:M}),R=await F.json();if(!F.ok)throw new Error(R.error??o("error.generic"));let W=R.data;W?.user&&i.currentUser&&(i.currentUser={...i.currentUser,avatar:W.user.avatar},i.fireCallbacks("login")),D=!1,L=o("profile.avatarUpdated"),h(),setTimeout(()=>{L="",h()},2e3)}catch{D=!1,h()}}}),c.getElementById("lmu-resend-verify")?.addEventListener("click",async()=>{if(s){try{await P($,"/api/auth/register",{appId:t,resendVerification:!0})}catch{}z=!0,h(),setTimeout(()=>{z=!1},5e3)}}),c.getElementById("lmu-name-edit")?.addEventListener("click",()=>{d=!0,l=i.currentUser?.displayName??"",x=!1,h(),c.getElementById("lmu-name-input")?.focus()}),c.getElementById("lmu-name-cancel")?.addEventListener("click",()=>{d=!1,h()}),c.getElementById("lmu-name-save")?.addEventListener("click",async()=>{let M=c.getElementById("lmu-name-input")?.value?.trim();if(!(!M||!s)){v=!0,h();try{await fe($,"/api/auth/profile",{displayName:M},s),i.currentUser&&(i.currentUser={...i.currentUser,displayName:M},i.fireCallbacks("login")),d=!1,x=!0,v=!1,h(),setTimeout(()=>{x=!1,h()},2e3)}catch{v=!1,h()}}}),c.getElementById("lmu-pw-show")?.addEventListener("click",()=>{w=!0,u="",g="",h()}),c.getElementById("lmu-pw-cancel")?.addEventListener("click",()=>{w=!1,u="",h()});let ue=c.getElementById("lmu-pw-form");ue?.addEventListener("submit",async I=>{I.preventDefault();let M=new FormData(ue),F=M.get("currentPassword"),R=M.get("newPassword"),W=M.get("confirmPassword");if(R!==W){u=o("profile.passwordMismatch"),h();return}if(R.length<8){u=o("error.passwordTooShort"),h();return}U=!0,u="",h();try{await ve($,"/api/auth/change-password",{currentPassword:F,newPassword:R},s),w=!1,U=!1,g=o("profile.passwordChanged"),h(),setTimeout(()=>{g="",h()},3e3)}catch(ce){u=ce instanceof Error?ce.message:o("error.generic"),U=!1,h()}}),c.getElementById("lmu-logout")?.addEventListener("click",()=>{te(),T()})}h(),document.body.appendChild(k)}function ke(e,t){let{accent:r,auth:a,theme:n,t:i,getLoginModalDeps:p,getProfileModalDeps:$,onLogout:o,onAuthChange:E}=e,T=B(A(n.isDark)),m=xe(r,T),f=typeof t=="string"?document.querySelector(t):t;if(!f)return()=>{};let s=document.createElement("div");s.className="lmu-profile-card-host";let d=s.attachShadow({mode:"closed"});n.registerHost(s);function l(){if(!a.currentUser){d.innerHTML=`
          <style>${m}</style>
      ...
      `,n.applyToHost(s),d.getElementById("lmu-pc-logout")?.addEventListener("click",()=>{o()}),d.getElementById("lmu-pc-edit")?.addEventListener("click",()=>{O($())})}f.appendChild(s),l();let v=E(()=>l());return()=>{v(),n.unregisterHost(s),s.remove()}}function $e(e,t){let{accent:r,auth:a,theme:n,t:i,getLoginModalDeps:p,getProfileModalDeps:$,onLogout:o,onAuthChange:E}=e,T=B(A(n.isDark)),m=we(r,T),f=typeof t=="string"?document.querySelector(t):t;if(!f)return()=>{};let s=document.createElement("div");s.className="lmu-avatar-host";let d=s.attachShadow({mode:"closed"});n.registerHost(s);let l=!1;function v(){if(!a.currentUser){d.innerHTML=`
          <style>${m}</style>
        ...
        `:""}
      `,n.applyToHost(s),d.getElementById("lmu-av-toggle")?.addEventListener("click",()=>{l=!l,v()}),d.getElementById("lmu-av-profile")?.addEventListener("click",()=>{l=!1,v(),O($())}),d.getElementById("lmu-av-logout")?.addEventListener("click",()=>{l=!1,o()})}function x(u){l&&!s.contains(u.target)&&(l=!1,v())}document.addEventListener("click",x),f.appendChild(s),v();let w=E(()=>{l=!1,v()});return()=>{w(),n.unregisterHost(s),document.removeEventListener("click",x),s.remove()}}var H=document.currentScript??document.querySelector('script[src*="/letmeuse.js"][data-app-id]'),_=H?.getAttribute("data-app-id")??"",Pe=H?.getAttribute("data-theme")??"light",ne=H?.getAttribute("data-accent")??"#2563eb",Z=H?.getAttribute("data-locale")??"en",Te=H?.getAttribute("data-mode")??"modal",N=H?.src?new URL(H.src).origin:window.location.origin;_||console.warn("[LetMeUse SDK] Missing data-app-id attribute on script tag.");var ee=me(Z),se=new G(Pe),le={baseUrl:N,t:ee},b=new Y(_,le);function Q(){return{appId:_,accent:ne,locale:Z,auth:b,theme:se,apiDeps:le,t:ee}}function ze(){return{appId:_,accent:ne,locale:Z,baseUrl:N,auth:b,theme:se,apiDeps:le,t:ee,getLoginModalDeps:Q,onLogout:()=>X.logout()}}function Le(){return{accent:ne,locale:Z,auth:b,theme:se,t:ee,getLoginModalDeps:Q,getProfileModalDeps:ze,onLogout:()=>X.logout(),onAuthChange:e=>X.onAuthChange(e)}}var ae=!1,X={get ready(){return b.ready},get user(){return b.currentUser},login(){if(Te==="redirect"){window.location.href=`${N}/login?app=${_}&redirect=${encodeURIComponent(window.location.href)}`;return}C(Q(),"login")},register(){if(Te==="redirect"){window.location.href=`${N}/login?app=${_}&redirect=${encodeURIComponent(window.location.href)}&tab=register`;return}C(Q(),"register")},async logout(){if(!ae){ae=!0;try{let e=b.getStoredAccessToken();if(e)try{await fetch(`${N}/api/auth/logout`,{method:"POST",headers:{Authorization:`Bearer ${e}`}})}catch{}b.clearTokens(),b.currentUser=null,b.cancelRefresh(),b.fireCallbacks("logout")}finally{ae=!1}}},getToken(){return b.getStoredAccessToken()},whenReady(){return b.whenReady()},onAuthChange(e){return b.onAuthChange(e)},openAdmin(){window.open(`${N}/admin`,"_blank")},openProfile(){O(ze())},renderProfileCard(e){return ke(Le(),e)},renderAvatar(e){return $e(Le(),e)}};window.letmeuse=X;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>b.init()):b.init();})();
